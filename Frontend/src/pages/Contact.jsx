  ...
  return (
    <div className="min-h-screen bg-cream py-16">
      <div className="container-custom">
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-display font-bold text-forest mb-4">Get in Touch</h1>
          <p className="text-gray-600 text-lg max-w-2xl">
            We're a local family store — always happy to help. Reach out on WhatsApp for the fastest response.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-transparent p-6 rounded-3xl relative overflow-hidden">
               ...
               <p className="text-sm text-gray-600 mb-4 leading-relaxed">
                 For over 20 years, our family has been at the heart of the community, sourcing the finest grains and freshest produce directly from local farmers.
               </p>
               <p className="text-sm text-gray-600 leading-relaxed">
                 What started as a small grain stall has grown into a trusted destination for quality. We believe that food is family, and every product we stock is something we'd serve at our own table.
               </p>
               <Store size={120} className="absolute -bottom-6 -right-6 text-primary-200/50 -rotate-12" />
            </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="bg-white rounded-3xl shadow-card p-8 lg:p-10 border border-gray-100">
              <h2 className="text-2xl font-display font-bold text-forest mb-8">Send us a message</h2>
              <form onSubmit={handleSendMessage} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-xs font-bold tracking-wider text-gray-500 uppercase mb-2">Full Name</label>
                    <input 
                      type="text" 
                      name="name" 
                      value={formData.name} 
                  ...
                  <div>
                    <label className="block text-xs font-bold tracking-wider text-gray-500 uppercase mb-2">Email Address</label>
                    <input 
                      type="email" 
                      name="email" 
                ...
                <div>
                  <label className="block text-xs font-bold tracking-wider text-gray-500 uppercase mb-2">Message</label>
                  <textarea 
                    name="message" 
                ...
                <div className="pt-2">
                  <button type="submit" className="bg-forest hover:bg-forest-light text-white font-semibold py-4 px-8 rounded-xl transition-colors flex items-center gap-2">
                     <Send size={18} />
                     Send Message
                  </button>
                  <p className="text-xs text-gray-400 italic mt-4">We'll reply via email within 24 hours</p>
                </div>
              </form>
            </div>
