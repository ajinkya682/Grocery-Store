...
const MasalaBanner = () => {
  ...
  const masala = products.find(p => p.id === 3);
    ...
    <section id="masala-banner" className="py-6 bg-cream">
      <div className="container-custom">
        <div
          ...
          style={{
            background: 'linear-gradient(135deg, #1a3a1a 0%, #2a5a20 40%, #3d6b2a 100%)',
          }}
        >
          {/* Decorative circles */}
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-0 min-h-[320px]">
            {/* Product image */}
            <div className="relative flex items-end justify-center md:justify-start overflow-hidden p-6 pb-0 md:pb-6">
              {/* "Our Brand" label */}
              <div className="absolute top-5 left-6 bg-saffron-500 text-white text-[10px] font-extrabold uppercase tracking-wider px-3 py-1 rounded-full shadow-lg">
                ✦ Our Own Collection
              </div>
              <img
            ...
            {/* Content */}
            <div className="flex flex-col justify-center px-6 md:pr-10 md:pl-4 pb-8 md:py-10">
              <span className="text-saffron-400 text-xs font-bold uppercase tracking-widest mb-3">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-bold text-white leading-tight mb-4">
                ...
                <span className="text-saffron-400">Authentic. Pure. Traditional.</span>
              </h2>
              <p className="text-gray-300 text-sm leading-relaxed mb-6 max-w-sm">
                Crafted from 15+ hand-selected spices using a generation-old family recipe. 
                No artificial colour, no preservatives — just the real fiery taste of Kolhapur.
              </p>
              ...
              <div className="flex items-center gap-4">
                <div>
                  <p className="text-gray-400 text-xs line-through">₹{masala?.originalPrice}</p>
                  <p className="text-white text-2xl font-bold">₹{masala?.price} <span className="text-sm font-normal text-gray-300">/ 250g</span></p>
                </div>
                <button
